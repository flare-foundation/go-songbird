...
import (
	...
	"github.com/flare-foundation/flare/coreth/accounts/keystore"
...
func TestMulticoin(t *testing.T) {
	...
	//}
	//counterSrc, err := filepath.Abs(gopath + "/src/github.com/flare-foundation/flare/coreth/examples/multicoin/mc_test.sol")
	//if err != nil {
	// 	t.Fatal(err)
	// }
