...
import (
	...
	"github.com/flare-foundation/flare/utils/storage"
...
func getStakingConfig(v *viper.Viper, networkID uint32) (node.StakingConfig, error) {
	...
	if !config.EnableStaking && (networkID == constants.CostonID || networkID == constants.SongbirdID) {
	...
	if networkID != constants.SongbirdID && networkID != constants.CostonID {
